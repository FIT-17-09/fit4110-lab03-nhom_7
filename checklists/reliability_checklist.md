...
Notes:
- No list endpoint in this contract, so list/detail test and pagination are not applicable.
- No enum fields in the request schema, so enum negative test is not applicable.
